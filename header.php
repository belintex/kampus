...
<head>
	...
	<link rel="icon" href="img/logo-title.png" type="image/png">
		...
		<!-- <div class="top_menu row m0">
			<div class="container-fluid">
				<div class="float-left">
					<p>Hubungi Kami: +62 852-7262-7800</p>
				</div>
						...
						<div class="row w-100">
							<div class="col-lg-7">
								<ul class="nav navbar-nav center_nav pull-right">
									...
									<li class="nav-item">
										<a class="nav-link" href="category.php">Event</a>
									</li>
							...
							<div class="col-lg-2">
								<ul class="nav navbar-nav navbar-right right_nav pull-right">
									<!-- <hr> -->
									<!-- <li class="nav-item">
										<a href="#" class="icons show-search">
											<i class="fa fa-search" aria-hidden="true"></i>
											<div class="search">
												<input type="text" placeholder="Event apa yang kamu cari?">
											</div>
										</a>
